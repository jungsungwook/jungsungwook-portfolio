...
const CareerPage = (props: Props) => {
    const items = [{
        title: "2016",
        cardTitle: "2016 (19살)",
        cardSubtitle: `" 처음 코딩을 접하다 "`,
        media: {
            name: "dunkirk beach",
            source: {
                url: "http://via.placeholder.com/630x500"
            },
            type: "IMAGE"
        },
        timelineContent: <div>
        ...
        title: "2017",
        cardTitle: "2017 (20살)",
        cardSubtitle: `" 대학에 입학하다 "`,
        media: {
            name: "dunkirk beach",
            source: {
                url: "http://via.placeholder.com/320x100"
            },
            type: "IMAGE"
        },
        timelineContent: <div>
